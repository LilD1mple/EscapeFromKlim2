...
{
	[RequireComponent(typeof(PlayerDamageProvider))]
	public class MeleeBerserkStateMachine : EnemyStateMachine
	{
		...
		private const float AwakeAnimationDuration = 1.5f;
		...
		public void Construct(IDifficultService difficultSerivce, ITargetService playerTarget, EventBus eventBus, PauseService pauseService)
		{
			...
			LoadConfig(difficultSerivce.DifficultConfiguration.MeleeBerserkConfig);
		}
