...
namespace NTC.Pool
{
    public static class NightPool
    {
        ...
        /// <summary>
        /// DiContainer for inject prefabs
        /// </summary>
        ...
        /// <summary>
        /// Method for inject container
        /// </summary>
        /// <param name="container"></param>
        public static void InjectContainer(DiContainer container) => _diContainer = container;
        ...
        public static void InstallPools(PoolsPreset poolsPreset)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                {
                    pool = CreateNewGameObjectPool(prefab, _diContainer);
        ...
        private static NightGameObjectPool CreateNewGameObjectPool(GameObject prefab, DiContainer container)
        {
            NightGameObjectPool nightGameObjectPool = new GameObject($"[{nameof(NightPool)}] {prefab.name}").AddComponent<NightGameObjectPool>();

            nightGameObjectPool.InjectContainer(container);

            return nightGameObjectPool;
        }
