...
namespace NTC.Pool
{
    ...
    public sealed class NightGameObjectPool : MonoBehaviour
    {
        ...
        public void InjectContainer(DiContainer container) => _diContainer = container;
        ...
        {
            GameObject newGameObject = _diContainer.InstantiatePrefab(_prefab);
